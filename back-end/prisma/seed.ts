    ...
    data: {
      ...
      Credits: {
        create: [
          ...
          { description: 'Freelance Job', debtor: 'Client', amount: 1200, paid: false },
          ...
          { description: 'Freelance Job', debtor: 'Client', amount: 1600, paid: false },
          ...
          { description: 'Freelance Job', debtor: 'Client', amount: 2300, paid: false },
        ]
      }
    }
  });
